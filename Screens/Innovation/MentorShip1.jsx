    ...
    <>
      ...
      <ScrollView style={{ backgroundColor: "white" }}>
        ...
        <View style={styles.container}>
          ...
          <Text style={{ padding: 20, fontSize: 20.62, fontWeight: 800, color: '#00A081' }}>For entrepreneurs register here!</Text>
         <View style={{padding:20}}>
          ...
          <Buttons title='Next' navigate='MentorShipEnter2'/>
         </View>
        </View>
      </ScrollView>
      <SMENavbar />
