...
<View style={{width:"100%", height:20,backgroundColor:"#E3F5F1", marginTop:20,
 ...
 <TouchableOpacity style={styles.btncard} onPress={() => navigation.navigate(props.navigate)}>

<Text style={{color:"white", fontSize:11}}>Repay</Text>
</TouchableOpacity>

<TouchableOpacity style={styles.btncard} onPress={() => navigation.navigate(props.navigate2)}>

<Text  style={{color:"white", fontSize:11}}>Schedule Payment</Text>
</TouchableOpacity>
