  ...
  return (
    <>
      ...
      <View style={styles.container}>
        ...
        <View>
            <Text style={{marginRight:"17%",fontSize:30, color:"#00A081", fontWeight:"bold"}}>
                $200
            </Text>
        </View>
        ...
        <View style={styles.container2}>
            ...
            <TouchableOpacity  onPress={() => navigation.navigate('ConvertCoins')} style={{width:"30%", height:45, backgroundColor:"#00A08133", justifyContent:"center",
