...
<TouchableOpacity   onPress={() => navigation.navigate('TotalBalanceScreen')} style={{width:"100%", backgroundColor:"#00A081", height:55,
 borderRadius:20,marginTop:10, justifyContent:"center", alignItems:"center", }}>

<Text style={{color:"white"}}>Request Loan</Text>
</TouchableOpacity>
    </>
