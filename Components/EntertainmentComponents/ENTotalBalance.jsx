      ...
      <View style={styles.container}>
        ...
        <View style={styles.container2}>
            ...
            <TouchableOpacity    onPress={() =>
                navigation.navigate('EntertainmentScreeen6')} style={{width:"30%", height:45, backgroundColor:"#00A08133", justifyContent:"center",
