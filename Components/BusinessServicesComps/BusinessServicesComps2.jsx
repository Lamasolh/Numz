  ...
  return (
    <>
        ...
        <View style={{marginTop:20}}>
          ...
          <Text style={{fontWeight:"bold", fontSize:23}}>{props.titlebr} </Text>
        </View>
        ...
        <Text style={{marginLeft:15}}>{props.txt1} </Text>
        </View>
        ...
        <Text style={{marginLeft:15}}>{props.txt2} </Text>
        </View>
        ...
        <Text style={{marginLeft:15}}>{props.txt3}</Text>
        </View>
